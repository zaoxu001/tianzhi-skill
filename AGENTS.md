<!-- 与 .claude/skills/tianzhi-core/SKILL.md 同源。那一份带 frontmatter，供 Claude Code 按需加载；
     这一份是跨工具通用约定（Codex / Copilot / Cursor / Gemini CLI 等三十多个 agent 都读 AGENTS.md）。
     改动请同时改两处，或以 SKILL.md 为正本。 -->
